...
Development
---------------------
The Pivx repo's [root README](https://github.com/kirgn/nexton/blob/master/README.md) contains relevant information on the development process and automated testing.
