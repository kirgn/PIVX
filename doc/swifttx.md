...
This mechanism has been integrated into Bitcore-Node-NextON which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/NextON-Project/insight-api-nexton#web-socket-api](https://github.com/NextON-Project/insight-api-nexton#web-socket-api) 
* API: [https://github.com/NextON-Project/insight-api-nexton#swifttx-transactions](https://github.com/NextON-Project/insight-api-nexton#swifttx-transactions) 
