...
In order to support loading of multiple wallets in nexton-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is nexton.cpp.
...
Changes to nexton.cpp
----------------------
nexton.cpp is the entry point into nexton-qt, and as such, will require some minor modifications to provide hooks for
