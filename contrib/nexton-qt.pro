...
RESOURCES += src/qt/nexton.qrc src/qt/nexton_locale.qrc

TRANSLATIONS += src/qt/locale/nexton_bg.ts \
                src/qt/locale/nexton_de.ts \
                src/qt/locale/nexton_en.ts \
                src/qt/locale/nexton_es.ts \
                src/qt/locale/nexton_fi.ts \
                src/qt/locale/nexton_fr.ts \
                src/qt/locale/nexton_it.ts \
                src/qt/locale/nexton_ja.ts \
                src/qt/locale/nexton_pl.ts \
                src/qt/locale/nexton_pt.ts \
                src/qt/locale/nexton_ru.ts \
                src/qt/locale/nexton_sk.ts \
                src/qt/locale/nexton_sv.ts \
                src/qt/locale/nexton_vi.ts \
                src/qt/locale/nexton_zh_CN.ts \
                src/qt/locale/nexton_zh_TW.ts
