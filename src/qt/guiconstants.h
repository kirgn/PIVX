...
/* NextON GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "NextON"
#define QAPP_ORG_DOMAIN "nexton.io"
#define QAPP_APP_NAME_DEFAULT "NextON-Qt"
#define QAPP_APP_NAME_TESTNET "NextON-Qt-testnet"
