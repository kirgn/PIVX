...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* NextON features */
        {"nexton", "masternode", &masternode, true, true, false},
        {"nexton", "listmasternodes", &listmasternodes, true, true, false},
        {"nexton", "getmasternodecount", &getmasternodecount, true, true, false},
        {"nexton", "masternodeconnect", &masternodeconnect, true, true, false},
        {"nexton", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"nexton", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"nexton", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"nexton", "masternodecurrent", &masternodecurrent, true, true, false},
        {"nexton", "masternodedebug", &masternodedebug, true, true, false},
        {"nexton", "startmasternode", &startmasternode, true, true, false},
        {"nexton", "createmasternodekey", &createmasternodekey, true, true, false},
        {"nexton", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"nexton", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"nexton", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"nexton", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"nexton", "getmasternodescores", &getmasternodescores, true, true, false},
        {"nexton", "mnbudget", &mnbudget, true, true, false},
        {"nexton", "preparebudget", &preparebudget, true, true, false},
        {"nexton", "submitbudget", &submitbudget, true, true, false},
        {"nexton", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"nexton", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"nexton", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"nexton", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"nexton", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"nexton", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"nexton", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"nexton", "checkbudgets", &checkbudgets, true, true, false},
        {"nexton", "mnsync", &mnsync, true, true, false},
        {"nexton", "spork", &spork, true, true, false},
        {"nexton", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> nexton-cli " + methodname + " " + args + "\n";
}
