...
confused with overall NextON Network Protocol consensus changes.
...
Patches that change NextON consensus rules are considerably more involved than
...
Where a patch set proposes to change the NextON consensus, it must have been
